...
const TopPhoto = () => {
    ...
    const handlePlayClick = () => {
        ...
        navigate(`/watch/movie/${data.data.id}`); // Assuming `data.data.id` contains the movie ID
    };

    const handleMoreInfoClick = () => {
        // Open the original TMDB path for the movie
        window.open(`https://www.themoviedb.org/movie/${data.data.id}`, '_blank'); // Replace with the actual TMDB URL
    };
